...
CUDA_VISIBLE_DEVICES=0 python mainCLIPKD_regularizerV2.py --mode train --arch resnet50 --dataset scene \
      --epoch 61 --lr 0.001 \
      --lr_steps 25 40 60 \
      --batch_size 128 \
      --train_add_strong  \
...
CUDA_VISIBLE_DEVICES=1 python mainCLIPKD_regularizerV2.py --mode train --arch resnet50 --dataset scene \
      --epoch 61 --lr 0.001 \
      --lr_steps 25 40 60 \
      --batch_size 128 \
      --train_add_weak  \
...
CUDA_VISIBLE_DEVICES=2 python mainCLIPKD_regularizerV2.py --mode train --arch resnet50 --dataset scene \
      --epoch 61 --lr 0.001 \
      --lr_steps 25 40 60 \
      --batch_size 128 \
      --train_add_strong  \
...
CUDA_VISIBLE_DEVICES=3 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset scene --teacher_num 3 \
...
CUDA_VISIBLE_DEVICES=1 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset scene --teacher_num 3 \
...
# T1s_T2w_T3s_Ss
CUDA_VISIBLE_DEVICES=2 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset scene --teacher_num 3 \
   --epoch 200 --temp 3.0 --alpha 0.6 --lr 0.001 \
   --lr_steps 190 195 0 \
...
CUDA_VISIBLE_DEVICES=1 python mainCLIPKD_regularizerV2_embdDistill.py --mode distil --arch resnet18 --dataset scene --teacher_num 3 \
   --epoch 500 --temp 3.0 --alpha 0.6 --lr 0.001 \
   --lr_steps 300 400 0 \
   --T1_add_strong --T1_add_weak --T4_add_strong_imgCATwordnet --S_add_strong \
...
CUDA_VISIBLE_DEVICES=3 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset scene --teacher_num 1 \
   --epoch 200 --temp 3.0 --alpha 0.6 --lr 0.001 \
   --lr_steps 190 195 0 \
