...
#CUDA_VISIBLE_DEVICES=2 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset UTKFace --teacher_num 3 \
...
CUDA_VISIBLE_DEVICES=2 python mainCLIPKD_regularizerV2_embdDistill.py --mode distil --arch resnet18 --dataset UTKFace --teacher_num 3 \
   --epoch 200 --temp 3.0 --alpha 0.6 --lr 0.001 \
   --lr_steps 190 195 0 \
   --T1_add_strong --T1_add_weak --T4_add_strong_imgCATwordnet --S_add_strong \
...
CUDA_VISIBLE_DEVICES=2 python mainCLIPKD_regularizerV2.py --mode distil --arch resnet18 --dataset UTKFace --teacher_num 1 \
   --epoch 200 --temp 3.0 --alpha 0.6 --lr 0.001 \
   --lr_steps 190 195 0 \
