...
CUDA_VISIBLE_DEVICES=3 python mainCLIPKD_naiveV1.py --mode train --arch resnet50 --dataset scene \
      --epoch 61 --lr 0.001 \
      --lr_steps 25 40 60 \
      --batch_size 128 \
      --train_add_strong  \
...
CUDA_VISIBLE_DEVICES=1 python mainCLIPKD_naiveV1.py --mode distil --arch resnet18 --dataset scene --teacher_num 3 \
