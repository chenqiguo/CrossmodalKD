...
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textGT_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textGT/"  # 输出文件夹
"""

"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textGT_20noise_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar" #"runs/CIFAR100_train_get_Ts_image_textGT_20noise/run-1-epoch61/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textGT_20noise/"  # 输出文件夹
"""
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textGT_50noise_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textGT_50noise/"  # 输出文件夹
"""
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textGT_80noise_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar" #"/root/autodl-tmp/CLIP_KD/runs/CIFAR100_train_get_Tw_image_textGT/run-2-epoch61/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textGT_80noise/"  # 输出文件夹
"""
#"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textGT_100noise_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textGT_100noise/"  # 输出文件夹
#"""


"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_text_20gt80wordnet_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_text_20gt80wordnet/"  # 输出文件夹
"""
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_textWordNet_V2_MLP/run-2-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_textWordNet/"  # 输出文件夹
"""
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_text_50gt50wordnet_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_text_50gt50wordnet/"  # 输出文件夹
"""
"""
MODEL_PATH = "runs/ImageNet-mini_train_get_Ts_image_text_80gt20wordnet_V2_MLP/run-1-epoch100/checkpoint_bestAcc1.pth.tar"
OUTPUT_DIR = "output_Captum/ImageNet-mini_train_get_Ts_image_text_80gt20wordnet/"  # 输出文件夹
"""
...
DATA_ROOT = "/home/ps/scratch/CLIP_KD/data/ImageNet-mini"
...
# 加载训练的模型
def load_model_MLP(model_path, num_classes=100, in_channels=1024):
    """
...
if __name__ == "__main__":
    ...
    # 加载 CIFAR-100 类别
    IMGNETMINI_CLASSES = load_imagenetmini_classes()

    # 加载训练模型
    trained_model = load_model_MLP(MODEL_PATH)
    ...
    # 加载 ImageNet-mini 测试数据
    dataset = "ImageNet-mini"
    phase = "val"
    batch_size = 128
    test_loader = Load_ImageNet(DATA_ROOT, dataset, phase, batch_size, shuffle=True)
    ...
    for idx, (images, _, labels) in enumerate(test_loader):
        ...
        # modified by Chenqi:
        words_gt = [IMGNETMINI_CLASSES[label] for label in labels_gt]
        ...
        if flag == 'noise':
            ...
            words_reg = [IMGNETMINI_CLASSES[label] for label in labels_reg]
