...
from trainer_naiveV1 import train_model_withCLIP,get_logfile_name,print_write
...
teacher_path = {
    ...
    #"weak_CLIPimg": "runs/CIFAR100_train_get_Tw_image/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"strong_CLIPimg": "runs/CIFAR100_train_get_Ts_imageCLIP/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"gt_CLIPtext": "runs/CIFAR100_train_get_Tw_textGT/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    #"wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_textWordNet/run-1-epoch61/checkpoint_bestAcc1.pth.tar", #"runs/CIFAR100_train_get_Tw_textWordNet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"70gt30wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_70gt30wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    #"30gt70wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_30gt70wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"80gt20wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_80gt20wordnet/run-3-epoch61/checkpoint_bestAcc1.pth.tar",
    #"20gt80wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_20gt80wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"50gt50wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_50gt50wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"90gt10wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_90gt10wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    #"10gt90wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_10gt90wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"95gt5wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_95gt5wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    #"5gt95wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_5gt95wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"1gt99wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_1gt99wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"3gt97wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_3gt97wordnet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"0gt100wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_0gt100wordnet/run-4-epoch400/checkpoint_bestAcc1.pth.tar", #"runs/CIFAR100_train_get_Ts_text_0gt100wordnet/run-2-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"60gt40wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_60gt40wordnet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"40gt60wordnet_CLIPtext": "runs/CIFAR100_train_get_Ts_text_40gt60wordnet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    
    #"gt20noise_CLIPtext": "runs/CIFAR100_train_get_Ts_textGT_20noise/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"image_textGT": "runs/CIFAR100_train_get_Tw_image_textGT/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"image_textWordNet": "runs/CIFAR100_train_get_Tw_image_textWordNet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"image_textGT_s": "runs/CIFAR100_train_get_Ts_image_textGT/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    ...
    #"image_text_10gt90wordnet": "runs/CIFAR100_train_get_Ts_image_text_10gt90wordnet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    #"image_text_1gt99wordnet": "runs/CIFAR100_train_get_Ts_image_text_1gt99wordnet/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    ...
    #"image_textWordNet_s": "runs/CIFAR100_imb100_train_get_Ts_image_textWordNet/run-8-epoch200/checkpoint_bestAcc1.pth.tar", #"runs/CIFAR100_imb100_train_get_Ts_image_textWordNet/run-6-epoch100/checkpoint_bestAcc1.pth.tar",
    #"strong_CLIPimg": "runs/CIFAR100_imb100_train_get_Ts_imageCLIP/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"image_textGT_s": "runs/CIFAR100_imb100_train_get_Ts_image_textGT/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    ...
    #"image_textWordNet_s": "runs/ImageNet_LT_train_get_Ts_image_textWordNet/run-1-epoch60/checkpoint_bestAcc1.pth.tar", 
    #"strong_CLIPimg": "runs/ImageNet_LT_train_get_Ts_imageCLIP/run-1-epoch60/checkpoint_bestAcc1.pth.tar",
    
    #"image_textGT_s": "runs/ImageNet_LT_train_get_Ts_image_textGT/run-1-epoch60/checkpoint_bestAcc1.pth.tar",
    ...
    #"strong_CLIPimg": "runs/ImageNet_train_get_Ts_imageCLIP/run-1-epoch35/checkpoint_bestAcc1.pth.tar",
    
    "image_textGT_s": "runs/ImageNet_train_get_Ts_image_textGT/run-1-epoch35/checkpoint_bestAcc1.pth.tar",
    ...
    #"image_textWordNet_s": "runs/scene_train_get_Ts_image_textWordNet_V1/run-1-epoch61/checkpoint_bestAcc1.pth.tar", 
    ...
    #"strong_CLIPimg": "runs/scene_train_get_Ts_imageCLIP/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"image_textGT_s": "runs/scene_train_get_Ts_image_textGT/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    ...
    #"image_textWordNet_s": "runs/UTKFace_train_get_Ts_image_textWordNet_V1/run-1-epoch61/checkpoint_bestAcc1.pth.tar", 
    ##"image_text_10gt90wordnet": "runs/ImageNet_train_get_Ts_image_text_10gt90wordnet_V2/run-1-epoch35/checkpoint_bestAcc1.pth.tar", 
    #"strong_CLIPimg": "runs/UTKFace_train_get_Ts_imageCLIP/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
    
    #"image_textGT_s": "runs/UTKFace_train_get_Ts_image_textGT/run-1-epoch61/checkpoint_bestAcc1.pth.tar",
...
def train(args, path, log_file, device):
    ...
    if args.mode == 'distil':
        ...
        if args.T2_add_weak_CLIPimg:          
            T_path.append(teacher_path['weak_CLIPimg'])
            key_strings.append('weak_CLIPimg')
        elif args.T2_add_strong_CLIPimg:
            T_path.append(teacher_path['strong_CLIPimg'])
            key_strings.append('strong_CLIPimg')

        if args.T3_add_gt:
            T_path.append(teacher_path['gt_CLIPtext'])
            key_strings.append('gt_CLIPtext')
        elif args.T3_add_wordnet:
            T_path.append(teacher_path['wordnet_CLIPtext'])
            key_strings.append('wordnet_CLIPtext')
        elif args.T3_add_70gt30wordnet:
            T_path.append(teacher_path['70gt30wordnet_CLIPtext'])
            key_strings.append('70gt30wordnet')
        elif args.T3_add_30gt70wordnet:
            T_path.append(teacher_path['30gt70wordnet_CLIPtext'])
            key_strings.append('30gt70wordnet')
        elif args.T3_add_80gt20wordnet:
            T_path.append(teacher_path['80gt20wordnet_CLIPtext'])
            key_strings.append('80gt20wordnet')
        elif args.T3_add_20gt80wordnet:
            T_path.append(teacher_path['20gt80wordnet_CLIPtext'])
            key_strings.append('20gt80wordnet')
        elif args.T3_add_50gt50wordnet:
            T_path.append(teacher_path['50gt50wordnet_CLIPtext'])
            key_strings.append('50gt50wordnet')
        elif args.T3_add_90gt10wordnet:
            T_path.append(teacher_path['90gt10wordnet_CLIPtext'])
            key_strings.append('90gt10wordnet')
        elif args.T3_add_10gt90wordnet:
            T_path.append(teacher_path['10gt90wordnet_CLIPtext'])
            key_strings.append('10gt90wordnet')
        elif args.T3_add_5gt95wordnet:
            T_path.append(teacher_path['5gt95wordnet_CLIPtext'])
            key_strings.append('5gt95wordnet')
        elif args.T3_add_95gt5wordnet:
            T_path.append(teacher_path['95gt5wordnet_CLIPtext'])
            key_strings.append('95gt5wordnet')
        elif args.T3_add_1gt99wordnet:
            T_path.append(teacher_path['1gt99wordnet_CLIPtext'])
            key_strings.append('1gt99wordnet')
        elif args.T3_add_3gt97wordnet:
            T_path.append(teacher_path['3gt97wordnet_CLIPtext'])
            key_strings.append('3gt97wordnet')
        elif args.T3_add_0gt100wordnet:
            T_path.append(teacher_path['0gt100wordnet_CLIPtext'])
            key_strings.append('0gt100wordnet')
        elif args.T3_add_60gt40wordnet:
            T_path.append(teacher_path['60gt40wordnet_CLIPtext'])
            key_strings.append('60gt40wordnet')
        elif args.T3_add_40gt60wordnet:
            T_path.append(teacher_path['40gt60wordnet_CLIPtext'])
            key_strings.append('40gt60wordnet')
        
        
        elif args.T3_add_gt_noise:
            T_path.append(teacher_path['gt20noise_CLIPtext'])
            key_strings.append('gt_CLIPtext')
        ...
        if args.T4_add_weak_imgCATgt:
            ...
            key_strings.append('image_textGT')
        if args.T4_add_weak_imgCATwordnet:
            T_path.append(teacher_path['image_textWordNet'])
            key_strings.append('image_textWordNet')
        elif args.T4_add_strong_imgCATwordnet:
            T_path.append(teacher_path['image_textWordNet_s'])
            key_strings.append('image_textWordNet')
        ...
        elif args.T4_add_strong_imgCAT1gt99wordnet:
            T_path.append(teacher_path['image_text_1gt99wordnet'])
            key_strings.append('image_text_1gt99wordnet')
