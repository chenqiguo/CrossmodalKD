...
def Load_CIFAR100(data_root, dataset, phase, batch_size, num_workers=4, shuffle=True):
    ...
    if dataset == 'CIFAR100_imb100':
        ...
        if phase == 'train' or phase == 'train_noAug':
            ...
            txt = '/home/ps/scratch/KD_imbalance/BalancedKnowledgeDistillation/data/cifar-100-python/val_paths.txt'
    elif txt is None:
        assert False
...
def Load_CIFAR100_noised(data_root, dataset, phase, batch_size, num_workers=4, noise_percent=20, shuffle=True):
    txt = None
    if dataset == 'CIFAR100_imb100':
        if phase == 'train' or phase == 'train_noAug':
            #txt = 'data_txt/cifar100/CIFAR100_train_imb100.txt'
...
def Load_CIFAR100_clean_noised(data_root, dataset, phase, batch_size, num_workers=4, noise_percent=20, shuffle=True):
    txt = None
    if dataset == 'CIFAR100_imb100':
        if phase == 'train' or phase == 'train_noAug':
            #txt = 'data_txt/cifar100/CIFAR100_train_imb100.txt'
