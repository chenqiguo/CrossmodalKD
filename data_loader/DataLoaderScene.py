...
def Load_scene(data_root, dataset, phase, batch_size, num_workers=4, shuffle=True):
    txt = None
    ...
    if dataset == 'scene':
        if phase == 'train' or phase == 'train_noAug':
            ...
            txt = '/home/ps/scratch/SSIM-DeepGenModelsImbaDataAug/data/scene/cleaned/val_paths.txt'
    elif txt is None:
        assert False
