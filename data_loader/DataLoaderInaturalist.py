...
def Load_inaturalist(data_root, dataset, phase, batch_size, num_workers=4, shuffle=True):
    txt = None
    
    if dataset == 'inaturalist':
        if phase == 'train' or phase == 'train_noAug':
            txt = "/home/ps/scratch/KD_imbalance/BalancedKnowledgeDistillation/data/inaturalist-2019/all/inaturalist_train.txt"
        elif phase == 'val' or phase == 'val_aug': #or phase == 'test':
            txt = '/home/ps/scratch/KD_imbalance/BalancedKnowledgeDistillation/data/inaturalist-2019/all/inaturalist_val.txt'
