...
if __name__ == '__main__':
    ...
    mydataset = 'CIFAR100'
    batch_size = 128
    noise_percent = 100 # only useful when prompt_type == 'noise'
    wn_percent = 20 # only useful when prompt_type == 'wn'
    prompt_type = 'noise' #'gt' #'noise' # 'wn'
    ...
    with torch.cuda.amp.autocast():
        with torch.no_grad():
            ...
            for batch_idx, (imgs_weak,_, labels) in enumerate(val_loader):
                ...
                Tx_entropy += get_entropy(outputs)
